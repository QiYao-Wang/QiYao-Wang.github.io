...
Hello, my name is Qiyao Wang (王琪尧). I am a second year Ph.D. student at the University of Chinese Academy of Sciences (UCAS), starting in Fall 2025, supervised by Prof. <a href="https://minyang.me/">Min Yang</a>.<br>
I obtained my Bachelor's degree in Artificial Intelligence from Dalian University of Technology (2021-2025).
During my undergraduate studies, I worked in the Dalian University of Technology <em>Information Retrieval Laboratory (DUT-IR)</em>
...
<p>博士生在读，目前以第一作者身份发表，自然语言处理国际顶级会议 ACL (CCF-A) 一篇，国内核心期刊《中文信息学报》（CCF-T1）一篇；以合作者身份参与发表，ACL (CCF-A) 一篇, ICLR (CCF-A) 一篇, NeurIPS (CCF-A) 一篇。国内发明专利申请 6 项，软件著作权授权 8 项。</p>
...
<ul>
  <li>Method for Audio Transcription Annotation and Analysis Based on Multi-Agent Collaboration Mechanism. Hongbo Wang, Yuan Lin, <strong><em>Qiyao Wang</em></strong>, Huanming Wang. CN120492633A. 2025.05.30. DUT. Pending. (Main Member)</li>
  ...
  <li>A Technology Integration Opportunity Prediction Method Based on Large Language Models. <strong><em>Qiyao Wang</em></strong>, Kan Xu, Shule Lu et.al. CN118246534A. 2024.06.25. DUT. Pending.
  </li>
</ul>
</details>
