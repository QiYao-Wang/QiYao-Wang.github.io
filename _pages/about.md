...
I will start my Ph.D. studies at CAS-SIAT in 2025, fortunately supervised by Prof. [Min Yang](minyang.me).
...
- ECPE-Qwen: Zero-Shot Emotion-Cause Pair Extraction with Fine-Tuning Large Language Models。 ***Qiyao Wang**, Liang Yang, Kan Xu, Yuan Lin, Hongfei Lin*. CCIR Accepted. Recommended to Journal of Chinese Information Processing (CCF B), Under Review. [[paper]()][[github](https://github.com/QiYao-Wang/ECPE-Qwen)]
