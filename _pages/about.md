...
<ul>
  ...
  <li><em><strong>2025.06.12:</strong></em> &nbsp;🎉 My undergraduate thesis titled "Research and Application of Large Language Models in the Intellectual Property Field" was awarded as an Outstanding Thesis (校本科优秀毕业论文) (<strong style="color:darkred;">Top 4.39%</strong>).</li>
...
- ***2025.06***: Undergraduate thesis "Research and Application of Large Language Models in the Intellectual Property Field" —— ***Outstanding Thesis (校本科优秀毕业论文)*** (<span style="color:darkred">***Top 4.39%***</span>)
